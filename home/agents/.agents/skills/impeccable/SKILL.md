...
name: impeccable
description: >-
  Explicit invocation only: use when the user names impeccable directly (e.g. "use impeccable", "/impeccable"). Deep frontend design/redesign playbook covering UX review, hierarchy, IA, accessibility, theming, motion, and design systems. Generic design, polish, audit, or critique requests route to design-engineer-bible (dxb) instead.
version: 3.9.1
---
