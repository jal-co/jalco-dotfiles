...
description: Production-ready CSS transitions for common web UI interactions. Use when implementing or reviewing motion for badges, dropdowns, modals, panels, page transitions, resizing cards, number/text/icon swaps, success/error states, skeletons and shimmers, tabs, tooltips, staggered reveals, hover effects, accordions, toasts, checkboxes, counters, toggles, AI activity, streaming text, loaders, or banner stacks. Also use to introduce or audit motion tokens for durations, distances, scales, blur, and easing. Triggers include "add a transition", "animate the dropdown", "make the modal open smoothly", "fade between", "stagger animation", "loading shimmer", "sliding tabs", "accordion", "toast", "toggle", "streaming text", "motion tokens", "scan for ad-hoc transitions", and the commands transitions reveal, review, apply, or refine.
---
