...
description: 'Add cinematic captions to a single-subject talking-head video. Choose from 36 identities in CATALOG.md, including verbatim anchor captions and stylized column-flow or themed treatments. Use for captions, subtitles, VFX captions, or named visual identities. Runs locally with HyperFrames; transcribes and mattes the subject without an API key.'
metadata:
