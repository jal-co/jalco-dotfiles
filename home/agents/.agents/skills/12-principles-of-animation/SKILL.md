...
description: >-
  Explicit invocation only: use when the user names the 12 principles of animation or this skill directly. Audits animation code against Disney's 12 principles with file:line findings. Generic motion review routes to design-engineer-bible (dxb) instead.
license: MIT
metadata:
