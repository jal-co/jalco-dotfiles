...
name: better-ui
description: >-
  Explicit invocation only: use when the user names better-ui directly. Design engineering principles for UI polish details (shadows, borders, micro-interactions, optical alignment). Generic polish or "feels off" requests route to design-engineer-bible (dxb) instead.
---
