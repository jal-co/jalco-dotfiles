...
description: >-
  Explicit invocation only: use when the user names impeccable-design-polish directly. Follow-up polish pass for an existing web/HTML artifact. Generic polish or audit requests route to design-engineer-bible (dxb) instead.
triggers:
  - "impeccable"
  - "design polish"
  - "polish page"
